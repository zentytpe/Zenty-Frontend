...
const Support: React.FC = () => {
    ...
    const faqs = [
        {
            question: "Comment enregistrer ma paume ?",
            answer: "Pour enregistrer votre paume, vous devez vous rendre chez un commerçant partenaire Zenty. Une fois sur place, demandez à enregistrer votre paume sur le terminal de paiement."
        },
        {
            question: "Est-ce sécurisé ?",
            answer: "Oui, Zenty utilise une technologie biométrique avancée qui analyse le réseau veineux de votre paume. Ces données sont chiffrées et stockées de manière sécurisée, conformément aux normes RGPD."
        },
        {
            question: "Comment ajouter une carte bancaire ?",
            answer: "Rendez-vous dans l'onglet 'Cartes' de votre espace personnel. Cliquez sur 'Ajouter une carte' et suivez les instructions."
        },
        {
            question: "Je ne reconnais pas un paiement, que faire ?",
            answer: "Consultez l'historique de vos transactions dans l'onglet 'Historique'. Si vous ne reconnaissez toujours pas un paiement, contactez immédiatement notre support via le formulaire ci-dessous."
        },
        {
            question: "Comment supprimer mon compte ?",
            answer: "Pour supprimer votre compte et toutes vos données biométriques, rendez-vous dans 'Paramètres' puis cliquez sur 'Supprimer mon compte'. Cette action est irréversible."
        }
    ];
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="Ex: Question sur un paiement, Données personnelles..."
                                    />
                                </div>
                            </div>
