...
const Settings: React.FC = () => {
    ...
    useEffect(() => {
        const fetchMerchantProfile = async () => {
            try {
                ...
                const response = await fetch(`${API_URL}/api/v1/merchants/me`, {
                    headers: {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Update form data with returned value to ensure synchronization
            setFormData({
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900">Paramètres Commerçant</h1>
